...
const REFERRER_DATA: Record<string, RefMonth> = {
  ...
  // Source: Salesforce "Monthly Submissions by Referral Type" export, August 20, 2026
  ...
  "2026-08": {total:897, Parent:27, "Dental Office":255, "Airway Ambassador":37, Influencer:164, Podcast:117, Instagram:36, TikTok:0, Facebook:1, "Meta Ad":0, "Online Search":167, "Unknown Referral":25, "Unknown Professional Referral":7, Other:0, "Google Ad":59, "Brand Ambassador":2},
};

/* ────── Current month projection ────── */
// Update these when changing the current partial month
const CURRENT_MONTH_KEY = '2026-08';
const CURRENT_MONTH_DAYS_TRACKED = 20;
