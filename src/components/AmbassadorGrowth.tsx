...
const addsTotalYear: Record<number, number> = {2023:6, 2024:133, 2025:174, 2026:214};
...
const baseByYear: Record<number, number> = {2023:517, 2024:2898, 2025:4642, 2026:2990};
...
const concRows = [
  ...
  {y:'2026', n:11, color:'#8CD1C8', names:'Shannon, Lauren, Sosh, Emily B., Eden, Kendra, Melody, Jeff, Amy B., Jasyra, Ginny'},
];

// Top 3 producers by month — from LBT H1+H2 exports for each year
// Source: LBT 2024 H1+H2, 2025 H1+H2, 2026 H1+H2, all exported 2026-09-17
type Top3Entry = {
...
const moversData: Record<string, {y25:number; y26:number; type:string}> = {
  ...
  'Amy Erickson':         {y25:51,   y26:47,  type:'Inf'},
  'Carly Brown':          {y25:0,    y26:45,  type:'Inf'},
  'Katelyn Alsop':        {y25:0,    y26:46,  type:'Inf'},
  'Thuy Improta':         {y25:245,  y26:35,  type:'Inf'},
  'Hilary Fritsch':       {y25:0,    y26:33,  type:'Inf'},
  ...
  'Erin Wilkins':         {y25:111,  y26:24,  type:'Inf'},
  ...
  'Amy Migdalia Williams':{y25:0,    y26:17,  type:'Inf'},
  'Michelle Keijner':     {y25:13,   y26:17,  type:'Amb'},
  'Hillary Ha':           {y25:0,    y26:14,  type:'Amb'},
  'Laura Manns':          {y25:0,    y26:13,  type:'Amb'},
  'Elise Hylden':         {y25:20,   y26:13,  type:'Amb'},
  'Courtland Nall':       {y25:10,   y26:13,  type:'Amb'},
  'Christina Franco':     {y25:0,    y26:12,  type:'Inf'},
  'Karyna Cast Korotkykh':{y25:24,   y26:12,  type:'Amb'},
  'Dr. Ameet Trivedi':    {y25:105,  y26:12,  type:'Inf'},
  'Lexi Fitzgerald':      {y25:0,    y26:11,  type:'Inf'},
  'Rachel Jayroe':        {y25:0,    y26:11,  type:'Amb'},
  ...
  'Janell Hampton':       {y25:0,    y26:6,   type:'Amb'},
  'Anna Brayton riseandclimb':{y25:0,y26:6,   type:'Amb'},
  'Tiffany Hubbard':      {y25:11,   y26:6,   type:'Amb'},
  'Cy Tidwell':           {y25:0,    y26:5,   type:'Amb'},
  'Ashley Vogt':          {y25:0,    y26:6,   type:'Amb'},
  'Ashlee Boyson':        {y25:0,    y26:5,   type:'Inf'},
  'Natalie Stahl':        {y25:0,    y26:5,   type:'Amb'},
  'Chad Rasmussen':       {y25:0,    y26:5,   type:'Amb'},
  'Kayla Monson':         {y25:0,    y26:5,   type:'Inf'},
  'Beth Leon':            {y25:0,    y26:5,   type:'Inf'},
};

// Launch Bonus Tracker — updated from Salesforce export 2026-09-17
...
const launchBonusData: {name:string;bonusSubs:number;tier:number;earned:number;paid:number;winStart:string;winEnd:string;tier1Date?:string;tier2Date?:string;is2026?:boolean;omit?:boolean;pendingPayout?:boolean}[] = [
  ...
  {name:'Hilary Fritsch*',bonusSubs:31,tier:1,earned:250,paid:250,winStart:'05/08/2026',winEnd:'12/31/2026',tier1Date:'07/31',is2026:true},
  ...
  {name:'Amy Erickson',bonusSubs:26,tier:1,earned:250,paid:0,winStart:'04/01/2026',winEnd:'12/31/2026',tier1Date:'09/14'},
  ...
  {name:'Wendy Ostapuk toxinfreeish',bonusSubs:18,tier:0,earned:0,paid:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Mary Catherine Oechslin momnp',bonusSubs:19,tier:0,earned:0,paid:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Courtland Nall',bonusSubs:12,tier:0,earned:0,paid:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Erin Wilkins essentiallyerin',bonusSubs:14,tier:0,earned:0,paid:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  ...
  {name:'Christina Franco',bonusSubs:11,tier:0,earned:0,paid:0,winStart:'05/27/2026',winEnd:'12/31/2026',is2026:true},
  ...
  {name:'Lucy Bochsler',bonusSubs:7,tier:0,earned:0,paid:0,winStart:'08/03/2026',winEnd:'12/31/2026',is2026:true},
  ...
  {name:'Karyna Cast Korotkykh',bonusSubs:8,tier:0,earned:0,paid:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Laura Bruner',bonusSubs:6,tier:0,earned:0,paid:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  ...
  {name:'Amy Migdalia Williams',bonusSubs:13,tier:0,earned:0,paid:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Anna Brayton riseandclimb',bonusSubs:4,tier:0,earned:0,paid:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  ...
  {name:'Beth Leon',bonusSubs:4,tier:0,earned:0,paid:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
