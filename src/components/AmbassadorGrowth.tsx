...
// Source: synced from REFERRER_DATA in ReferrerView.tsx (Salesforce "Monthly Submissions by Referral Type" export, Sep 14 2026)
const ambSubs: Record<string, number> = {
  ...
  '2026-01':53,'2026-02':60,'2026-03':70,'2026-04':68,'2026-05':53,'2026-06':47,'2026-07':87,'2026-08':51,'2026-09':12,
};
const infSubs: Record<string, number> = {
  ...
  '2026-01':309,'2026-02':510,'2026-03':461,'2026-04':233,'2026-05':269,'2026-06':306,'2026-07':600,'2026-08':522,'2026-09':103,
};
...
const newAddsAmb: Record<string, number> = {
  ...
  '2026-01':5,'2026-02':12,'2026-03':10,'2026-04':28,'2026-05':20,'2026-06':28,'2026-07':29,'2026-08':35,'2026-09':11,
};
...
const ambSubsYear: Record<number, number> = {2023:465, 2024:442, 2025:574, 2026:501};
const infSubsYear: Record<number, number> = {2023:1337, 2024:8275, 2025:5525, 2026:3313};
const combSubsYear: Record<number, number> = {2023:1802, 2024:8717, 2025:6099, 2026:3814};
const addsAmbYear: Record<number, number> = {2023:4, 2024:72, 2025:141, 2026:178};
...
const addsTotalYear: Record<number, number> = {2023:6, 2024:133, 2025:174, 2026:213};
...
const tenPlusByYear: Record<number, number> = {2023:8, 2024:40, 2025:55, 2026:47}; // 47 with >=10 subs as of Sep 14
// Mega-3 = Lauren Johnson + Kendra Needham + Ginny Yurich (specific named producers, not top-3-by-volume)
// 2026: Lauren 547 + Kendra 183 + Ginny 112 = 842; base = LBT total 3814 - 842
const mega3ByYear: Record<number, number> = {2023:1290, 2024:5935, 2025:1508, 2026:842};
const baseByYear: Record<number, number> = {2023:517, 2024:2898, 2025:4642, 2026:2972};
...
const recruit26: {label:string; amb:number; inf:number; pod:number; accent:string; tag?:string}[] = [
  ...
  {label:'Sep', amb:11, inf:1, pod:1, accent:'#8CD1C8'},
];
...
// Source: LBT 2024 H1+H2, 2025 H1+H2, 2026 H1+H2, all exported 2026-09-14
type Top3Entry = {
...
const TOP3_MONTHLY: Top3Entry[] = [
  ...
  {month:'2026-09',label:'Sep',total:115,p1:{name:'Shannon Tripp',count:34},p2:{name:'Amy Bernhard',count:8},p3:{name:'Lauren Johnson',count:6},rest:67},
];
...
const PRODUCER_HISTORY: {name:string; y24:number; y25:number; y26:number; type:string}[] = [
  {name:'Shannon Tripp',         y24:0,    y25:866,  y26:655,  type:'Inf'},
  {name:'Lauren Johnson NNM',    y24:2956, y25:831,  y26:547,  type:'Inf'},
  {name:'Soshanna Salsman',      y24:299,  y25:914,  y26:250,  type:'Inf'},
  {name:'Kendra Needham',        y24:1851, y25:386,  y26:183,  type:'Inf'},
  {name:'Amy Bernhard',          y24:0,    y25:112,  y26:151,  type:'Inf'},
  ...
  {name:'Amy Erickson',          y24:141,  y25:51,   y26:46,   type:'Inf'},
...
const TOP5_CONCENTRATION: {year:number; top5Pct:number; restPct:number; top5:number; rest:number; total:number; names:string}[] = [
  ...
  {year:2026, top5Pct:46.8, restPct:53.2, top5:1786, rest:2028, total:3814, names:'Shannon, Lauren, Sosh, Kendra, Amy B.'},
];

// Updated from Salesforce Launch Bonus Tracker export 2026-09-14
// Source: LB Tracker combined H1 (Jan-Jun30) + H2 (Jul1-Sep14), exported 2026-09-14
const moversData: Record<string, {y25:number; y26:number; type:string}> = {
  'Shannon Tripp':        {y25:866,  y26:655, type:'Inf'},
  'Lauren Johnson NNM':   {y25:831,  y26:547, type:'Inf'},
  'Soshanna Salsman':     {y25:914,  y26:250, type:'Inf'},
  'Kendra Needham':       {y25:386,  y26:183, type:'Inf'},
  'Jeff Cruz Talia_likeitis': {y25:84, y26:145, type:'Inf'},
  'Amy Bernhard':         {y25:112,  y26:151, type:'Inf'},
  ...
  'Amy Erickson':         {y25:51,   y26:46,  type:'Inf'},
...
// Launch Bonus Tracker — updated from Salesforce export 2026-09-14
// 231 ambassadors with ≥1 YTD submission. Pre-2026 onboards: window starts 04/01/2026.
...
const launchBonusData: {name:string;bonusSubs:number;tier:number;earned:number;paid:number;winStart:string;winEnd:string;tier1Date?:string;tier2Date?:string;is2026?:boolean;omit?:boolean;pendingPayout?:boolean}[] = [
  {name:'Lauren Johnson NNM',bonusSubs:432,tier:2,earned:1250,paid:1250,winStart:'04/01/2026',winEnd:'12/31/2026',tier1Date:'04/27',tier2Date:'06/11'},
  ...
  {name:'Shannon Tripp',bonusSubs:448,tier:2,earned:1250,paid:1250,winStart:'04/01/2026',winEnd:'12/31/2026',tier1Date:'04/21',tier2Date:'05/26'},
  ...
  {name:'Eden Lee loverlees',bonusSubs:79,tier:2,earned:1250,paid:250,winStart:'04/01/2026',winEnd:'12/31/2026',tier1Date:'07/10',tier2Date:'07/30',pendingPayout:true},
  {name:'Kendra Needham',bonusSubs:72,tier:2,earned:1250,paid:1250,winStart:'04/01/2026',winEnd:'12/31/2026',tier1Date:'05/22',tier2Date:'07/13'},
  ...
  {name:'Amy Bernhard',bonusSubs:70,tier:2,earned:1250,paid:250,winStart:'04/01/2026',winEnd:'12/31/2026',tier1Date:'06/03',tier2Date:'07/29',pendingPayout:true},
  ...
  {name:'Lauren Stadler',bonusSubs:25,tier:1,earned:250,paid:0,winStart:'04/01/2026',winEnd:'12/31/2026',tier1Date:'09/11'},
  {name:'Amy Erickson',bonusSubs:25,tier:1,earned:250,paid:0,winStart:'04/01/2026',winEnd:'12/31/2026',tier1Date:'09/14'},
