...
const ambSubs: Record<string, number> = {
  ...
  '2026-01':53,'2026-02':61,'2026-03':67,'2026-04':68,'2026-05':53,'2026-06':45,'2026-07':79,'2026-08':8,
};
const infSubs: Record<string, number> = {
  ...
  '2026-01':309,'2026-02':511,'2026-03':462,'2026-04':233,'2026-05':269,'2026-06':306,'2026-07':593,'2026-08':49,
};
...
const newAddsAmb: Record<string, number> = {
  ...
  '2026-01':5,'2026-02':12,'2026-03':10,'2026-04':28,'2026-05':20,'2026-06':28,'2026-07':29,'2026-08':12,
};
...
const ambSubsYear: Record<number, number> = {2023:465, 2024:443, 2025:574, 2026:434};
const infSubsYear: Record<number, number> = {2023:1337, 2024:8279, 2025:5531, 2026:2732};
const combSubsYear: Record<number, number> = {2023:1802, 2024:8722, 2025:6105, 2026:3166};
const addsAmbYear: Record<number, number> = {2023:4, 2024:72, 2025:141, 2026:144};
const addsInfYear: Record<number, number> = {2023:2, 2024:61, 2025:29, 2026:24};
const addsTotalYear: Record<number, number> = {2023:6, 2024:133, 2025:171, 2026:170};
...
const mega3ByYear: Record<number, number> = {2023:1290, 2024:5935, 2025:1508, 2026:776};
const baseByYear: Record<number, number> = {2023:517, 2024:2898, 2025:4642, 2026:2390};
...
const recruit26: {label:string; amb:number; inf:number; accent:string; tag?:string}[] = [
  ...
  {label:'Aug', amb:12, inf:0, accent:'#D6E5F7'},
];
...
// Updated from Salesforce Launch Bonus Tracker export 2026-08-05
const moversData: Record<string, {y25:number; y26:number; type:string}> = {
  'Shannon Tripp':        {y25:866,  y26:314, type:'Inf'},
  'Soshanna Salsman':     {y25:914,  y26:241, type:'Inf'},
  'Lauren Johnson NNM':   {y25:831,  y26:508, type:'Inf'},
  'Kendra Needham':       {y25:386,  y26:167, type:'Inf'},
  ...
  'Taylor Kulik':         {y25:103,  y26:65,  type:'Inf'},
  ...
  'Thuy Improta':         {y25:245,  y26:34,  type:'Inf'},
...
// Launch Bonus Tracker — updated from Salesforce export 2026-08-05
