...
const LAUNCH_BONUS_PAYOUTS: {month:string; payouts:{name:string;amount:number;tier:string;pending?:boolean;note?:string}[]}[] = [
  ...
  { month: 'September 2026', payouts: [
    { name: 'Eden Lee loverlees', amount: 1000, tier: 'Tier 2', note: 'Hit T2 07/30 — T1 paid Aug' },
    { name: 'Amy Bernhard', amount: 1000, tier: 'Tier 2', note: 'Hit 50+ on 07/29' },
    { name: 'Jeff Cruz Talia_likeitis', amount: 1000, tier: 'Tier 2', note: 'Hit 50+ on 07/31' },
    { name: 'Melody Brandon', amount: 1000, tier: 'Tier 2', note: 'Hit 50+ on 08/03' },
    { name: 'Jasyra Santiago-Hines', amount: 1000, tier: 'Tier 2', note: 'Hit 50+ on 08/24' },
    { name: 'Taylor Kulik', amount: 250, tier: 'Tier 1', note: 'Hit 25+ on 07/25' },
    { name: 'Hilary Fritsch*', amount: 250, tier: 'Tier 1', note: 'Hit 25+ on 07/31' },
  ]},
];
...
const launchBonusData: {name:string;bonusSubs:number;tier:number;earned:number;paid:number;winStart:string;winEnd:string;tier1Date?:string;tier2Date?:string;is2026?:boolean;omit?:boolean;pendingPayout?:boolean}[] = [
  ...
  {name:'Amy Bernhard',bonusSubs:70,tier:2,earned:1250,paid:1250,winStart:'04/01/2026',winEnd:'12/31/2026',tier1Date:'06/03',tier2Date:'07/29'},
  ...
  {name:'Jasyra Santiago-Hines',bonusSubs:50,tier:2,earned:1250,paid:1250,winStart:'04/01/2026',winEnd:'12/31/2026',tier1Date:'06/10',tier2Date:'08/24'},
  ...
  {name:'Hilary Fritsch*',bonusSubs:30,tier:1,earned:250,paid:250,winStart:'05/08/2026',winEnd:'12/31/2026',tier1Date:'07/31',is2026:true},
