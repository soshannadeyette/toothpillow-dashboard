...
const addsTotalYear: Record<number, number> = {2023:6, 2024:133, 2025:171, 2026:101};
...
const recruit26: {label:string; amb:number; inf:number; accent:string; tag?:string}[] = [
  ...
  {label:'Jun', amb:7, inf:0, accent:'#DD5759'},
];
...
const moversData: Record<string, {y25:number; y26:number; type:string}> = {
  ...
  'Hayley Lombard':       {y25:0,    y26:15,  type:'Inf'},
...
// 98 ambassadors with ≥1 bonus-eligible submission (counted from window start only).
...
const launchBonusData: {name:string;bonusSubs:number;tier:number;earned:number;winStart:string;winEnd:string;is2026?:boolean;omit?:boolean}[] = [
  {name:'Soshanna Salsman',bonusSubs:65,tier:2,earned:1250,winStart:'04/01/2026',winEnd:'04/01/2027',omit:true},
  ...
  {name:'Kendra Needham',bonusSubs:36,tier:1,earned:250,winStart:'04/01/2026',winEnd:'04/01/2027'},
  ...
  {name:'Eryn Carroll',bonusSubs:9,tier:0,earned:0,winStart:'04/01/2026',winEnd:'04/01/2027'},
  ...
  {name:'Ellen Fisher',bonusSubs:8,tier:0,earned:0,winStart:'04/01/2026',winEnd:'04/01/2027'},
  ...
  {name:'Hillary Ha',bonusSubs:5,tier:0,earned:0,winStart:'04/01/2026',winEnd:'04/01/2027'},
  ...
  {name:'Lexi Fitzgerald',bonusSubs:4,tier:0,earned:0,winStart:'04/01/2026',winEnd:'04/01/2027'},
  {name:'Michelle Keijner',bonusSubs:4,tier:0,earned:0,winStart:'04/01/2026',winEnd:'04/01/2027'},
  ...
  {name:'Kelsey Sem',bonusSubs:3,tier:0,earned:0,winStart:'04/01/2026',winEnd:'04/01/2027'},
  ...
  {name:'Erin Wilkins',bonusSubs:2,tier:0,earned:0,winStart:'04/01/2026',winEnd:'04/01/2027'},
  ...
  {name:'Brooke Quinn',bonusSubs:1,tier:0,earned:0,winStart:'02/19/2026',winEnd:'02/19/2027',is2026:true},
  ...
  {name:'Elizabeth Bagwell',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'04/01/2027'},
  ...
  {name:'Lindsay Cardwell',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'04/01/2027'},
  ...
  {name:'Sam Johnson',bonusSubs:1,tier:0,earned:0,winStart:'02/06/2026',winEnd:'02/06/2027',is2026:true},
