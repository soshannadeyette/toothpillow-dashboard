...
// Source: synced from REFERRER_DATA in ReferrerView.tsx (Salesforce "Monthly Submissions by Referral Type" export, Sep 10 2026)
const ambSubs: Record<string, number> = {
  ...
  '2026-01':53,'2026-02':61,'2026-03':70,'2026-04':68,'2026-05':53,'2026-06':46,'2026-07':88,'2026-08':51,'2026-09':9,
};
const infSubs: Record<string, number> = {
  ...
  '2026-01':309,'2026-02':511,'2026-03':462,'2026-04':234,'2026-05':269,'2026-06':306,'2026-07':600,'2026-08':523,'2026-09':79,
};
...
const newAddsAmb: Record<string, number> = {
  ...
  '2026-01':5,'2026-02':12,'2026-03':10,'2026-04':28,'2026-05':20,'2026-06':28,'2026-07':29,'2026-08':35,'2026-09':10,
};
...
const ambSubsYear: Record<number, number> = {2023:465, 2024:442, 2025:574, 2026:499};
const infSubsYear: Record<number, number> = {2023:1337, 2024:8275, 2025:5525, 2026:3293};
const combSubsYear: Record<number, number> = {2023:1802, 2024:8717, 2025:6099, 2026:3792};
const addsAmbYear: Record<number, number> = {2023:4, 2024:72, 2025:141, 2026:177};
...
const addsTotalYear: Record<number, number> = {2023:6, 2024:133, 2025:174, 2026:212};
...
const activeTotalByYear: Record<number, number> = {2023:30, 2024:145, 2025:209, 2026:230};

const halfCarriedBy: Record<number, number> = {2023:1, 2024:2, 2025:5, 2026:11};
const tenPlusByYear: Record<number, number> = {2023:8, 2024:40, 2025:55, 2026:47}; // 47 with >=10 subs as of Sep 10
// Mega-3 = Lauren Johnson + Kendra Needham + Ginny Yurich (specific named producers, not top-3-by-volume)
// 2026: Lauren 541 + Kendra 182 + Ginny 111 = 834; base = LBT total 3788 - 834
const mega3ByYear: Record<number, number> = {2023:1290, 2024:5935, 2025:1508, 2026:834};
const baseByYear: Record<number, number> = {2023:517, 2024:2898, 2025:4642, 2026:2954};
...
const recruit26: {label:string; amb:number; inf:number; pod:number; accent:string; tag?:string}[] = [
  ...
  {label:'Mar', amb:10, inf:2, pod:1, accent:'#3A6EA4'},
  ...
  {label:'Sep', amb:10, inf:1, pod:1, accent:'#8CD1C8'},
];
...
const concRows = [
  ...
  {y:'2026', n:11, color:'#8CD1C8', names:'Lauren, Shannon, Sosh, Emily B., Eden, Kendra, Melody, Jeff, Amy B., Jasyra, Ginny'},
];

// Top 3 producers by month — from LBT H1+H2 exports for each year
// Source: LBT 2024 H1+H2, 2025 H1+H2, 2026 H1+H2, all exported 2026-09-10
type Top3Entry = {
...
const TOP3_MONTHLY: Top3Entry[] = [
  ...
  {month:'2026-09',label:'Sep',total:69,p1:{name:'Shannon Tripp',count:34},p2:{name:'Amy Bernhard',count:8},p3:{name:'Lauren Johnson',count:6},rest:21},
];
...
const PRODUCER_HISTORY: {name:string; y24:number; y25:number; y26:number; type:string}[] = [
  {name:'Shannon Tripp',         y24:0,    y25:866,  y26:650,  type:'Inf'},
  {name:'Lauren Johnson NNM',    y24:2956, y25:831,  y26:541,  type:'Inf'},
  {name:'Soshanna Salsman',      y24:299,  y25:914,  y26:250,  type:'Inf'},
  {name:'Kendra Needham',        y24:1851, y25:386,  y26:182,  type:'Inf'},
  {name:'Amy Bernhard',          y24:0,    y25:112,  y26:148,  type:'Inf'},
  {name:'Jeff Cruz',             y24:259,  y25:84,   y26:145,  type:'Inf'},
  {name:'Melody Brandon',        y24:137,  y25:123,  y26:126,  type:'Inf'},
  {name:'Ginny Yurich',          y24:1110, y25:291,  y26:111,  type:'Inf'},
  {name:'Eden Lee',              y24:25,   y25:185,  y26:108,  type:'Inf'},
  {name:'Jasyra Santiago-Hines', y24:100,  y25:57,   y26:102,  type:'Inf'},
  {name:'Emily Boazman',         y24:0,    y25:0,    y26:96,   type:'Inf'},
  {name:'Ellen Fisher',          y24:40,   y25:53,   y26:73,   type:'Inf'},
  {name:'Taylor Kulik',          y24:156,  y25:103,  y26:69,   type:'Inf'},
  {name:'Lauren Stadler',        y24:46,   y25:93,   y26:47,   type:'Inf'},
  {name:'Amy Erickson',          y24:141,  y25:51,   y26:45,   type:'Inf'},
  {name:'Thuy Improta',          y24:204,  y25:245,  y26:35,   type:'Inf'},
  {name:'Eryn Carroll NMM',      y24:144,  y25:104,  y26:32,   type:'Inf'},
  {name:'Erin Wilkins',          y24:285,  y25:111,  y26:23,   type:'Inf'},
  {name:'Devon Kuntzman',        y24:133,  y25:90,   y26:21,   type:'Inf'},
  {name:'Wendy Ostapuk',         y24:85,   y25:104,  y26:20,   type:'Inf'},
];

// Top-5 concentration by year (% of total amb+inf submissions from top 5 producers)
// 2024: 8,722 total → top 5 = 74.7%  2025: 6,105 total → top 5 = 64.9%  2026: 3,792 YTD → top 5 = 46.6%
const TOP5_CONCENTRATION: {year:number; top5Pct:number; restPct:number; top5:number; rest:number; total:number; names:string}[] = [
  ...
  {year:2026, top5Pct:46.6, restPct:53.4, top5:1768, rest:2024, total:3792, names:'Shannon, Lauren, Sosh, Kendra, Jeff'},
];

// Updated from Salesforce Launch Bonus Tracker export 2026-09-10
// Source: LB Tracker combined H1 (Jan-Jun30) + H2 (Jul1-Sep10), exported 2026-09-10
const moversData: Record<string, {y25:number; y26:number; type:string}> = {
  'Shannon Tripp':        {y25:866,  y26:650, type:'Inf'},
  'Lauren Johnson NNM':   {y25:831,  y26:541, type:'Inf'},
  'Soshanna Salsman':     {y25:914,  y26:250, type:'Inf'},
  'Kendra Needham':       {y25:386,  y26:182, type:'Inf'},
  'Jeff Cruz Talia_likeitis': {y25:84, y26:145, type:'Inf'},
  'Amy Bernhard':         {y25:112,  y26:148, type:'Inf'},
  'Melody Brandon':       {y25:123,  y26:126, type:'Inf'},
  'Ginny Yurich':         {y25:291,  y26:111, type:'Inf'},
  'Eden Lee loverlees':   {y25:185,  y26:108, type:'Inf'},
  'Jasyra Santiago-Hines':{y25:57,   y26:102, type:'Inf'},
  'Emily Boazman':        {y25:0,    y26:96,  type:'Inf'},
  'Ellen Fisher':         {y25:53,   y26:73,  type:'Inf'},
  'Taylor Kulik':         {y25:103,  y26:69,  type:'Inf'},
  'Lauren Stadler':       {y25:93,   y26:47,  type:'Inf'},
  'Amy Erickson':         {y25:51,   y26:45,  type:'Inf'},
  'Carly Brown':          {y25:0,    y26:45,  type:'Inf'},
  'Katelyn Alsop':        {y25:0,    y26:45,  type:'Inf'},
  'Thuy Improta':         {y25:245,  y26:35,  type:'Inf'},
  'Hilary Fritsch':       {y25:0,    y26:32,  type:'Inf'},
  'Melina Moses':         {y25:28,   y26:30,  type:'Amb'},
  'Eryn Carroll NMM':     {y25:104,  y26:32,  type:'Inf'},
  'Hayley Lombard':       {y25:0,    y26:29,  type:'Inf'},
  'Ashley Turner':        {y25:39,   y26:27,  type:'Inf'},
  'Jennie Hoglund':       {y25:29,   y26:26,  type:'Inf'},
  'Erin Wilkins':         {y25:111,  y26:23,  type:'Inf'},
  'Mary Catherine Oechslin':{y25:0,  y26:24,  type:'Inf'},
  'Alicia Nussbaum':      {y25:0,    y26:21,  type:'Amb'},
  'Devon Kuntzman':       {y25:90,   y26:21,  type:'Inf'},
  'Taylor Moran':         {y25:62,   y26:20,  type:'Inf'},
  'Taylor Weimar':        {y25:0,    y26:19,  type:'Inf'},
  'Wendy Ostapuk':        {y25:104,  y26:20,  type:'Inf'},
...
// Launch Bonus Tracker — updated from Salesforce export 2026-09-10
// 230 ambassadors with ≥1 YTD submission. Pre-2026 onboards: window starts 04/01/2026.
...
const LAUNCH_BONUS_PAYOUTS: {month:string; payouts:{name:string;amount:number;tier:string;pending?:boolean;note?:string}[]}[] = [
  ...
  { month: 'September 2026', payouts: [
    { name: 'Eden Lee loverlees', amount: 1000, tier: 'Tier 2', pending: true, note: 'Hit T2 07/30 — T1 paid Aug' },
    ...
    { name: 'Jasyra Santiago-Hines', amount: 1000, tier: 'Tier 2', pending: true, note: 'Hit 50+ on 08/24' },
...
const launchBonusData: {name:string;bonusSubs:number;tier:number;earned:number;paid:number;winStart:string;winEnd:string;tier1Date?:string;tier2Date?:string;is2026?:boolean;omit?:boolean;pendingPayout?:boolean}[] = [
  {name:'Lauren Johnson NNM',bonusSubs:426,tier:2,earned:1250,paid:1250,winStart:'04/01/2026',winEnd:'12/31/2026',tier1Date:'04/27',tier2Date:'06/11'},
  ...
  {name:'Shannon Tripp',bonusSubs:443,tier:2,earned:1250,paid:1250,winStart:'04/01/2026',winEnd:'12/31/2026',tier1Date:'04/21',tier2Date:'05/26'},
  {name:'Emily Boazman',bonusSubs:93,tier:2,earned:1250,paid:1250,winStart:'04/02/2026',winEnd:'12/31/2026',tier1Date:'05/24',tier2Date:'06/26',is2026:true},
  {name:'Eden Lee loverlees',bonusSubs:77,tier:2,earned:1250,paid:250,winStart:'04/01/2026',winEnd:'12/31/2026',tier1Date:'07/10',tier2Date:'07/30',pendingPayout:true},
  {name:'Kendra Needham',bonusSubs:71,tier:2,earned:1250,paid:1250,winStart:'04/01/2026',winEnd:'12/31/2026',tier1Date:'05/22',tier2Date:'07/13'},
  {name:'Melody Brandon',bonusSubs:62,tier:2,earned:1250,paid:250,winStart:'04/01/2026',winEnd:'12/31/2026',tier1Date:'06/08',tier2Date:'08/03',pendingPayout:true},
  {name:'Amy Bernhard',bonusSubs:67,tier:2,earned:1250,paid:250,winStart:'04/01/2026',winEnd:'12/31/2026',tier1Date:'06/03',tier2Date:'07/29',pendingPayout:true},
  {name:'Jeff Cruz Talia_likeitis',bonusSubs:60,tier:2,earned:1250,paid:250,winStart:'04/01/2026',winEnd:'12/31/2026',tier1Date:'05/19',tier2Date:'07/31',pendingPayout:true},
  {name:'Jasyra Santiago-Hines',bonusSubs:50,tier:2,earned:1250,paid:250,winStart:'04/01/2026',winEnd:'12/31/2026',tier1Date:'06/10',tier2Date:'08/24',pendingPayout:true},
  {name:'Ginny Yurich',bonusSubs:53,tier:2,earned:1250,paid:250,winStart:'04/01/2026',winEnd:'12/31/2026',tier1Date:'06/02',tier2Date:'09/03'},
  ...
  {name:'Katelyn Alsop (James)',bonusSubs:45,tier:1,earned:250,paid:250,winStart:'01/19/2026',winEnd:'12/31/2026',tier1Date:'02/21',is2026:true},
  {name:'Taylor Kulik',bonusSubs:34,tier:1,earned:250,paid:0,winStart:'04/01/2026',winEnd:'12/31/2026',tier1Date:'07/25',pendingPayout:true},
  {name:'Hilary Fritsch*',bonusSubs:30,tier:1,earned:250,paid:0,winStart:'05/08/2026',winEnd:'12/31/2026',tier1Date:'07/31',is2026:true,pendingPayout:true},
  ...
  {name:'Lauren Stadler',bonusSubs:24,tier:0,earned:0,paid:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Eryn Carroll NMM',bonusSubs:23,tier:0,earned:0,paid:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Thuy Improta',bonusSubs:20,tier:0,earned:0,paid:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Alicia Nussbaum',bonusSubs:21,tier:0,earned:0,paid:0,winStart:'07/06/2026',winEnd:'12/31/2026',is2026:true},
  {name:'Wendy Ostapuk toxinfreeish',bonusSubs:17,tier:0,earned:0,paid:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Mary Catherine Oechslin momnp',bonusSubs:24,tier:0,earned:0,paid:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Courtland Nall',bonusSubs:11,tier:0,earned:0,paid:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Erin Wilkins essentiallyerin',bonusSubs:12,tier:0,earned:0,paid:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  ...
  {name:'Hillary Ha',bonusSubs:9,tier:0,earned:0,paid:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Taylor Weimar',bonusSubs:8,tier:0,earned:0,paid:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Ashley Turner',bonusSubs:8,tier:0,earned:0,paid:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  ...
  {name:'Karyna Cast Korotkykh',bonusSubs:6,tier:0,earned:0,paid:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  ...
  {name:'Amy Migdalia Williams',bonusSubs:10,tier:0,earned:0,paid:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
            ...
            <div style={{ height: 260 }}>
              <Bar
                ...
                options={{
                  ...
                  scales: {
                    x: { ticks: { autoSkip: false, maxRotation: 90, font: { size: 9 }, callback: function(value) { const k = ALL_MONTHS[value as number]; return k?.endsWith('-01') ? k?.split('-')[0] : ''; } } },
      ...
      <div>
        ...
        <div style={{ fontSize: '0.7rem', color: '#888', marginTop: 8, textAlign: 'center' }}>
          {launchBonusData.length} ambassadors with ≥1 submission. Source: Salesforce Launch Bonus Tracker, September 1 2026.
        </div>
      </div>
