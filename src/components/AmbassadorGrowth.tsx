...
const recruit26: {label:string; amb:number; inf:number; accent:string; tag?:string}[] = [
  ...
  {label:'Jun', amb:24, inf:4, accent:'#DD5759'},
];
...
// Updated from Salesforce Launch Bonus Tracker export 2026-06-26
const moversData: Record<string, {y25:number; y26:number; type:string}> = {
  'Shannon Tripp':        {y25:866,  y26:289, type:'Inf'},
  'Soshanna Salsman':     {y25:914,  y26:208, type:'Inf'},
  'Lauren Johnson NNM':   {y25:831,  y26:175, type:'Inf'},
  'Kendra Needham':       {y25:386,  y26:157, type:'Inf'},
  'Amy Bernhard':         {y25:112,  y26:120, type:'Inf'},
  'Jeff Cruz':            {y25:84,   y26:120, type:'Inf'},
  'Melody Brandon':       {y25:123,  y26:93,  type:'Inf'},
  'Ginny Yurich':         {y25:291,  y26:89,  type:'Inf'},
  'Jasyra Santiago-Hines':{y25:57,   y26:83,  type:'Inf'},
  'Ellen Fisher':         {y25:53,   y26:65,  type:'Inf'},
  'Taylor Kulik':         {y25:103,  y26:52,  type:'Inf'},
  'Emily Boazman':        {y25:0,    y26:52,  type:'Inf'},
  'Eden Lee':             {y25:185,  y26:44,  type:'Inf'},
  'Amy Erickson':         {y25:51,   y26:41,  type:'Inf'},
  ...
  'Hayley Lombard':       {y25:0,    y26:21,  type:'Inf'},
  ...
  'Mary Catherine Oechslin':{y25:0,  y26:9,   type:'Inf'},
...
// Launch Bonus Tracker — updated from Salesforce export 2026-06-26
// 116 ambassadors with ≥1 WINDOW submission (counted from window start, not YTD).
...
const launchBonusData: {name:string;bonusSubs:number;tier:number;earned:number;paid:number;winStart:string;winEnd:string;tier1Date?:string;tier2Date?:string;is2026?:boolean;omit?:boolean}[] = [
  {name:'Soshanna Salsman',bonusSubs:86,tier:2,earned:1250,paid:0,winStart:'04/01/2026',winEnd:'12/31/2026',tier1Date:'04/25',tier2Date:'05/28',omit:true},
  {name:'Shannon Tripp',bonusSubs:82,tier:2,earned:1250,paid:1250,winStart:'04/01/2026',winEnd:'12/31/2026',tier1Date:'04/21',tier2Date:'05/26'},
  ...
  {name:'Emily Boazman',bonusSubs:49,tier:1,earned:250,paid:250,winStart:'04/02/2026',winEnd:'12/31/2026',is2026:true,tier1Date:'05/24'},
  ...
  {name:'Amy Bernhard',bonusSubs:39,tier:1,earned:250,paid:0,winStart:'04/01/2026',winEnd:'12/31/2026',tier1Date:'06/04'},
  {name:'Jeff Cruz Talia_likeitis',bonusSubs:35,tier:1,earned:250,paid:250,winStart:'04/01/2026',winEnd:'12/31/2026',tier1Date:'05/19'},
  {name:'Ginny Yurich',bonusSubs:31,tier:1,earned:250,paid:0,winStart:'04/01/2026',winEnd:'12/31/2026',tier1Date:'06/02'},
  {name:'Jasyra Santiago-Hines',bonusSubs:31,tier:1,earned:250,paid:0,winStart:'04/01/2026',winEnd:'12/31/2026',tier1Date:'06/10'},
  {name:'Melody Brandon',bonusSubs:28,tier:1,earned:250,paid:0,winStart:'04/01/2026',winEnd:'12/31/2026',tier1Date:'06/08'},
  {name:'Carly Brown',bonusSubs:28,tier:1,earned:250,paid:0,winStart:'04/21/2026',winEnd:'12/31/2026',is2026:true,tier1Date:'06/24'},
  {name:'Hayley Lombard',bonusSubs:21,tier:0,earned:0,paid:0,winStart:'05/19/2026',winEnd:'12/31/2026',is2026:true},
  {name:'Amy Erickson',bonusSubs:20,tier:0,earned:0,paid:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  ...
  {name:'Mary Catherine Oechslin momnp',bonusSubs:3,tier:0,earned:0,paid:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
