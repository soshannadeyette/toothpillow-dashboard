...
const ambSubs: Record<string, number> = {
  ...
  '2026-01':53,'2026-02':58,'2026-03':64,'2026-04':64,'2026-05':21,
};
const infSubs: Record<string, number> = {
  ...
  '2026-01':312,'2026-02':517,'2026-03':463,'2026-04':237,'2026-05':133,
};
...
const newAddsAmb: Record<string, number> = {
  ...
  '2026-01':5,'2026-02':13,'2026-03':10,'2026-04':28,'2026-05':17,
};
...
const ambSubsYear: Record<number, number> = {2023:465, 2024:435, 2025:566, 2026:260};
const infSubsYear: Record<number, number> = {2023:1339, 2024:8398, 2025:5583, 2026:1662};
const combSubsYear: Record<number, number> = {2023:1804, 2024:8833, 2025:6149, 2026:1922};
const addsAmbYear: Record<number, number> = {2023:4, 2024:72, 2025:141, 2026:73};
const addsInfYear: Record<number, number> = {2023:2, 2024:61, 2025:29, 2026:16};
const addsTotalYear: Record<number, number> = {2023:6, 2024:133, 2025:171, 2026:89};
...
const baseByYear: Record<number, number> = {2023:517, 2024:2898, 2025:4642, 2026:1576};

const ANN = 12 / 4.677; // 4 full months + 21/31 of May through 5/21
...
const recruit26 = [
  ...
  {label:'May', amb:17, inf:4, accent:'#B26CA6', tag:'through 5/20'},
];
...
const moversData: Record<string, {y25:number; y26:number; type:string}> = {
  'Shannon Tripp':        {y25:866,  y26:254, type:'Inf'},
  'Soshanna Salsman':     {y25:914,  y26:159, type:'Inf'},
  'Lauren Johnson NNM':   {y25:831,  y26:151, type:'Inf'},
  'Kendra Needham':       {y25:386,  y26:135, type:'Inf'},
  'Jeff Cruz':            {y25:84,   y26:109, type:'Inf'},
  'Amy Bernhard':         {y25:112,  y26:93,  type:'Inf'},
  'Ginny Yurich':         {y25:291,  y26:75,  type:'Inf'},
  'Melody Brandon':       {y25:123,  y26:74,  type:'Inf'},
  'Jasyra Santiago-Hines':{y25:57,   y26:68,  type:'Inf'},
  'Ellen Fisher':         {y25:53,   y26:57,  type:'Inf'},
  'Taylor Kulik':         {y25:103,  y26:45,  type:'Inf'},
  'Katelyn Alsop':        {y25:0,    y26:40,  type:'Inf'},
  'Eden Lee':             {y25:185,  y26:38,  type:'Inf'},
  'Amy Erickson':         {y25:51,   y26:31,  type:'Inf'},
  'Jennie Hoglund':       {y25:29,   y26:24,  type:'Inf'},
  'Lauren Stadler':       {y25:93,   y26:24,  type:'Inf'},
  'Thuy Improta':         {y25:245,  y26:22,  type:'Inf'},
  'Emily Boazman':        {y25:0,    y26:21,  type:'Inf'},
...
// Launch Bonus Tracker — updated from Salesforce export 2026-05-20
const launchBonusData = [
  {name:'Shannon Tripp',onboard:'06/27/2025',is2026:false,winStart:'04/01/2026',winEnd:'04/01/2027',bonusSubs:254,tier:1,earned:250},
  {name:'Soshanna Salsman',onboard:'04/30/2024',is2026:false,winStart:'04/01/2026',winEnd:'04/01/2027',bonusSubs:159,tier:1,earned:250},
  {name:'Lauren Johnson NNM',onboard:'05/01/2024',is2026:false,winStart:'04/01/2026',winEnd:'04/01/2027',bonusSubs:151,tier:1,earned:250},
  {name:'Kendra Needham',onboard:'11/01/2023',is2026:false,winStart:'04/01/2026',winEnd:'04/01/2027',bonusSubs:135,tier:1,earned:250},
  {name:'Jeff Cruz Talia_likeitis',onboard:'08/01/2024',is2026:false,winStart:'04/01/2026',winEnd:'04/01/2027',bonusSubs:109,tier:1,earned:250},
  {name:'Amy Bernhard',onboard:'08/25/2025',is2026:false,winStart:'04/01/2026',winEnd:'04/01/2027',bonusSubs:93,tier:1,earned:250},
  {name:'Ginny Yurich',onboard:'06/01/2024',is2026:false,winStart:'04/01/2026',winEnd:'04/01/2027',bonusSubs:75,tier:1,earned:250},
  {name:'Melody Brandon',onboard:'04/01/2024',is2026:false,winStart:'04/01/2026',winEnd:'04/01/2027',bonusSubs:74,tier:1,earned:250},
  {name:'Jasyra Santiago-Hines',onboard:'02/01/2024',is2026:false,winStart:'04/01/2026',winEnd:'04/01/2027',bonusSubs:68,tier:1,earned:250},
  {name:'Ellen Fisher',onboard:'01/01/2024',is2026:false,winStart:'04/01/2026',winEnd:'04/01/2027',bonusSubs:57,tier:1,earned:250},
  {name:'Taylor Kulik',onboard:'02/01/2024',is2026:false,winStart:'04/01/2026',winEnd:'04/01/2027',bonusSubs:45,tier:1,earned:250},
  ...
  {name:'Eden Lee loverlees',onboard:'12/01/2024',is2026:false,winStart:'04/01/2026',winEnd:'04/01/2027',bonusSubs:38,tier:1,earned:250},
  {name:'Amy Erickson',onboard:'01/01/2024',is2026:false,winStart:'04/01/2026',winEnd:'04/01/2027',bonusSubs:31,tier:1,earned:250},
  {name:'Jennie Hoglund',onboard:'01/01/2024',is2026:false,winStart:'04/01/2026',winEnd:'04/01/2027',bonusSubs:24,tier:0,earned:0},
  {name:'Lauren Stadler',onboard:'01/01/2024',is2026:false,winStart:'04/01/2026',winEnd:'04/01/2027',bonusSubs:24,tier:0,earned:0},
  {name:'Thuy Improta *ministry*',onboard:'07/01/2024',is2026:false,winStart:'04/01/2026',winEnd:'04/01/2027',bonusSubs:22,tier:0,earned:0},
  {name:'Emily Boazman',onboard:'04/02/2026',is2026:true,winStart:'04/02/2026',winEnd:'04/02/2027',bonusSubs:21,tier:0,earned:0},
  {name:'Ashley Turner',onboard:'01/01/2024',is2026:false,winStart:'04/01/2026',winEnd:'04/01/2027',bonusSubs:21,tier:0,earned:0},
  {name:'Carly Brown',onboard:'04/21/2026',is2026:true,winStart:'04/21/2026',winEnd:'04/21/2027',bonusSubs:19,tier:0,earned:0},
  {name:'Taylor Moran',onboard:'01/01/2024',is2026:false,winStart:'04/01/2026',winEnd:'04/01/2027',bonusSubs:19,tier:0,earned:0},
  {name:'Eryn Carroll NMM',onboard:'07/01/2024',is2026:false,winStart:'04/01/2026',winEnd:'04/01/2027',bonusSubs:17,tier:0,earned:0},
  {name:'Taylor Weimar',onboard:'01/01/2024',is2026:false,winStart:'04/01/2026',winEnd:'04/01/2027',bonusSubs:14,tier:0,earned:0},
  {name:'Devon Kuntzman',onboard:'01/01/2024',is2026:false,winStart:'04/01/2026',winEnd:'04/01/2027',bonusSubs:13,tier:0,earned:0},
  {name:'Erin Wilkins',onboard:'01/01/2024',is2026:false,winStart:'04/01/2026',winEnd:'04/01/2027',bonusSubs:12,tier:0,earned:0},
  {name:'Karalynne Call *Just Ingredients*',onboard:'08/01/2024',is2026:false,winStart:'04/01/2026',winEnd:'04/01/2027',bonusSubs:11,tier:0,earned:0},
  {name:'Laura Manns',onboard:'01/01/2024',is2026:false,winStart:'04/01/2026',winEnd:'04/01/2027',bonusSubs:10,tier:0,earned:0},
];
...
export default function AmbassadorGrowth() {
  ...
  const mayPaceFactor = 31 / 21; // May 2026: 21 days so far out of 31
