...
const ambSubs: Record<string, number> = {
  ...
  '2026-01':52,'2026-02':57,'2026-03':63,'2026-04':64,'2026-05':50,'2026-06':35,
};
const infSubs: Record<string, number> = {
  ...
  '2026-01':311,'2026-02':511,'2026-03':462,'2026-04':232,'2026-05':268,'2026-06':258,
};
...
const newAddsAmb: Record<string, number> = {
  ...
  '2026-01':5,'2026-02':13,'2026-03':10,'2026-04':28,'2026-05':20,'2026-06':20,
};
...
const ambSubsYear: Record<number, number> = {2023:465, 2024:435, 2025:566, 2026:321};
const infSubsYear: Record<number, number> = {2023:1339, 2024:8398, 2025:5583, 2026:2042};
const combSubsYear: Record<number, number> = {2023:1804, 2024:8833, 2025:6149, 2026:2363};
const addsAmbYear: Record<number, number> = {2023:4, 2024:72, 2025:141, 2026:96};
const addsInfYear: Record<number, number> = {2023:2, 2024:61, 2025:29, 2026:21};
const addsTotalYear: Record<number, number> = {2023:6, 2024:133, 2025:171, 2026:118};
...
const mega3ByYear: Record<number, number> = {2023:1290, 2024:5935, 2025:1508, 2026:420};
const baseByYear: Record<number, number> = {2023:517, 2024:2898, 2025:4642, 2026:1944};
...
const recruit26: {label:string; amb:number; inf:number; accent:string; tag?:string}[] = [
  ...
  {label:'Jun', amb:20, inf:4, accent:'#DD5759'},
];
...
// Updated from Salesforce Launch Bonus Tracker export 2026-06-25
const moversData: Record<string, {y25:number; y26:number; type:string}> = {
  'Shannon Tripp':        {y25:866,  y26:289, type:'Inf'},
  'Soshanna Salsman':     {y25:914,  y26:207, type:'Inf'},
  'Lauren Johnson NNM':   {y25:831,  y26:174, type:'Inf'},
  'Kendra Needham':       {y25:386,  y26:157, type:'Inf'},
  'Amy Bernhard':         {y25:112,  y26:119, type:'Inf'},
  ...
  'Carly Brown':          {y25:0,    y26:25,  type:'Inf'},
  'Jennie Hoglund':       {y25:29,   y26:24,  type:'Inf'},
  'Ashley Turner':        {y25:39,   y26:22,  type:'Inf'},
  'Eryn Carroll NMM':     {y25:104,  y26:22,  type:'Inf'},
  ...
  'Mary Catherine Oechslin':{y25:0,  y26:8,   type:'Inf'},
  ...
  'Lauren Peter':         {y25:37,   y26:7,   type:'Amb'},
  'Jessi Meeks':          {y25:0,    y26:6,   type:'Amb'},
  'Tiffany Hubbard':      {y25:11,   y26:6,   type:'Amb'},
  'Ashley Vogt':          {y25:0,    y26:5,   type:'Amb'},
};

// Launch Bonus Tracker — updated from Salesforce export 2026-06-25
// 114 ambassadors with ≥1 WINDOW submission (counted from window start, not YTD).
...
const launchBonusData: {name:string;bonusSubs:number;tier:number;earned:number;paid:number;winStart:string;winEnd:string;tier1Date?:string;tier2Date?:string;is2026?:boolean;omit?:boolean}[] = [
  {name:'Soshanna Salsman',bonusSubs:85,tier:2,earned:1250,paid:0,winStart:'04/01/2026',winEnd:'12/31/2026',tier1Date:'04/25',tier2Date:'05/28',omit:true},
  ...
  {name:'Lauren Johnson NNM',bonusSubs:59,tier:2,earned:1250,paid:250,winStart:'04/01/2026',winEnd:'12/31/2026',tier1Date:'04/27',tier2Date:'06/10'},
  ...
  {name:'Amy Bernhard',bonusSubs:38,tier:1,earned:250,paid:0,winStart:'04/01/2026',winEnd:'12/31/2026',tier1Date:'06/04'},
  ...
  {name:'Carly Brown',bonusSubs:24,tier:0,earned:0,paid:0,winStart:'04/21/2026',winEnd:'12/31/2026',is2026:true},
  ...
  {name:'Eryn Carroll NMM',bonusSubs:13,tier:0,earned:0,paid:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
      ...
      <div>
        ...
        <div style={{ fontSize: '0.7rem', color: '#888', marginTop: 8, textAlign: 'center' }}>
          {launchBonusData.length} ambassadors with ≥1 submission. Source: Salesforce Launch Bonus Tracker, June 19 2026.
        </div>
      </div>
