...
const ambSubs: Record<string, number> = {
  ...
  '2026-01':52,'2026-02':57,'2026-03':63,'2026-04':64,'2026-05':50,'2026-06':45,'2026-07':16,
};
const infSubs: Record<string, number> = {
  ...
  '2026-01':311,'2026-02':511,'2026-03':462,'2026-04':232,'2026-05':268,'2026-06':304,'2026-07':41,
};
...
const newAddsInf: Record<string, number> = {
  ...
  '2026-01':3,'2026-02':1,'2026-03':2,'2026-04':5,'2026-05':6,'2026-06':4,'2026-07':1,
};

const ambSubsYear: Record<number, number> = {2023:465, 2024:435, 2025:566, 2026:347};
const infSubsYear: Record<number, number> = {2023:1339, 2024:8398, 2025:5583, 2026:2129};
const combSubsYear: Record<number, number> = {2023:1804, 2024:8833, 2025:6149, 2026:2476};
...
// Updated from Salesforce Launch Bonus Tracker export 2026-07-08
const moversData: Record<string, {y25:number; y26:number; type:string}> = {
  'Shannon Tripp':        {y25:866,  y26:294, type:'Inf'},
  'Soshanna Salsman':     {y25:914,  y26:215, type:'Inf'},
  'Lauren Johnson NNM':   {y25:831,  y26:178, type:'Inf'},
  'Kendra Needham':       {y25:386,  y26:158, type:'Inf'},
  'Jeff Cruz':            {y25:84,   y26:126, type:'Inf'},
  'Amy Bernhard':         {y25:112,  y26:125, type:'Inf'},
  'Melody Brandon':       {y25:123,  y26:94,  type:'Inf'},
  'Ginny Yurich':         {y25:291,  y26:94,  type:'Inf'},
  'Jasyra Santiago-Hines':{y25:57,   y26:83,  type:'Inf'},
  'Ellen Fisher':         {y25:53,   y26:66,  type:'Inf'},
  'Taylor Kulik':         {y25:103,  y26:54,  type:'Inf'},
  'Emily Boazman':        {y25:0,    y26:53,  type:'Inf'},
  'Eden Lee':             {y25:185,  y26:51,  type:'Inf'},
  'Amy Erickson':         {y25:51,   y26:44,  type:'Inf'},
  'Katelyn Alsop':        {y25:0,    y26:40,  type:'Inf'},
  'Lauren Stadler':       {y25:93,   y26:40,  type:'Inf'},
  'Thuy Improta':         {y25:245,  y26:31,  type:'Inf'},
  'Carly Brown':          {y25:0,    y26:31,  type:'Inf'},
  'Jennie Hoglund':       {y25:29,   y26:25,  type:'Inf'},
  'Eryn Carroll NMM':     {y25:104,  y26:24,  type:'Inf'},
  'Ashley Turner':        {y25:39,   y26:23,  type:'Inf'},
  'Hayley Lombard':       {y25:0,    y26:23,  type:'Inf'},
  'Hilary Fritsch':       {y25:0,    y26:21,  type:'Inf'},
  'Taylor Moran':         {y25:62,   y26:20,  type:'Inf'},
  'Taylor Weimar':        {y25:0,    y26:17,  type:'Inf'},
  ...
  'Carly Hartwig':        {y25:0,    y26:8,   type:'Inf'},
  ...
  'Kelsey Tweeton':       {y25:0,    y26:6,   type:'Inf'},
  'Tiffany Hubbard':      {y25:11,   y26:6,   type:'Inf'},
  'Mary Catherine Oechslin':{y25:0,  y26:13,  type:'Inf'},
  'Melina Moses':         {y25:28,   y26:18,  type:'Amb'},
...
// Launch Bonus Tracker — updated from Salesforce export 2026-07-08
// 129 ambassadors with ≥1 WINDOW submission (counted from window start, not YTD).
...
const launchBonusData: {name:string;bonusSubs:number;tier:number;earned:number;paid:number;winStart:string;winEnd:string;tier1Date?:string;tier2Date?:string;is2026?:boolean;omit?:boolean}[] = [
  {name:'Soshanna Salsman',bonusSubs:94,tier:2,earned:1250,paid:0,winStart:'04/01/2026',winEnd:'12/31/2026',tier1Date:'04/25',tier2Date:'05/28',omit:true},
  {name:'Shannon Tripp',bonusSubs:87,tier:2,earned:1250,paid:1250,winStart:'04/01/2026',winEnd:'12/31/2026',tier1Date:'04/21',tier2Date:'05/26'},
  {name:'Lauren Johnson NNM',bonusSubs:63,tier:2,earned:1250,paid:250,winStart:'04/01/2026',winEnd:'12/31/2026',tier1Date:'04/27',tier2Date:'06/11'},
  ...
  {name:'Amy Bernhard',bonusSubs:44,tier:1,earned:250,paid:0,winStart:'04/01/2026',winEnd:'12/31/2026',tier1Date:'06/04'},
  ...
  {name:'Ginny Yurich',bonusSubs:36,tier:1,earned:250,paid:0,winStart:'04/01/2026',winEnd:'12/31/2026',tier1Date:'06/02'},
  ...
  {name:'Carly Brown',bonusSubs:30,tier:1,earned:250,paid:0,winStart:'04/21/2026',winEnd:'12/31/2026',is2026:true,tier1Date:'06/24'},
  ...
  {name:'Eden Lee loverlees',bonusSubs:20,tier:0,earned:0,paid:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  ...
  {name:'Ellen Fisher',bonusSubs:16,tier:0,earned:0,paid:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Thuy Improta *ministry*',bonusSubs:16,tier:0,earned:0,paid:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  ...
  {name:'Carly Hartwig',bonusSubs:8,tier:0,earned:0,paid:0,winStart:'04/06/2026',winEnd:'12/31/2026',is2026:true},
  ...
  {name:'Mary Catherine Oechslin momnp',bonusSubs:8,tier:0,earned:0,paid:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  ...
  {name:'Kelsey Tweeton',bonusSubs:6,tier:0,earned:0,paid:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  ...
  {name:'Alicia Nussbaum',bonusSubs:3,tier:0,earned:0,paid:0,winStart:'07/06/2026',winEnd:'12/31/2026',is2026:true},
