...
const ambSubs: Record<string, number> = {
  ...
  '2026-01':53,'2026-02':58,'2026-03':64,'2026-04':64,'2026-05':45,'2026-06':5,
};
const infSubs: Record<string, number> = {
  ...
  '2026-01':312,'2026-02':517,'2026-03':463,'2026-04':238,'2026-05':271,'2026-06':89,
};
...
const ambSubsYear: Record<number, number> = {2023:465, 2024:435, 2025:566, 2026:289};
const infSubsYear: Record<number, number> = {2023:1339, 2024:8398, 2025:5583, 2026:1890};
const combSubsYear: Record<number, number> = {2023:1804, 2024:8833, 2025:6149, 2026:2179};
...
const addsTotalYear: Record<number, number> = {2023:6, 2024:133, 2025:171, 2026:107};
...
const recruit26: {label:string; amb:number; inf:number; accent:string; tag?:string}[] = [
  ...
  {label:'Jun', amb:9, inf:2, accent:'#DD5759'},
];
...
// Updated from Salesforce Launch Bonus Tracker export 2026-06-10
const moversData: Record<string, {y25:number; y26:number; type:string}> = {
  'Shannon Tripp':        {y25:866,  y26:270, type:'Inf'},
  'Soshanna Salsman':     {y25:914,  y26:195, type:'Inf'},
  'Lauren Johnson NNM':   {y25:831,  y26:164, type:'Inf'},
  'Kendra Needham':       {y25:386,  y26:150, type:'Inf'},
  'Jeff Cruz':            {y25:84,   y26:114, type:'Inf'},
  'Amy Bernhard':         {y25:112,  y26:110, type:'Inf'},
  'Ginny Yurich':         {y25:291,  y26:85,  type:'Inf'},
  'Melody Brandon':       {y25:123,  y26:87,  type:'Inf'},
  'Jasyra Santiago-Hines':{y25:57,   y26:77,  type:'Inf'},
  'Ellen Fisher':         {y25:53,   y26:62,  type:'Inf'},
  'Taylor Kulik':         {y25:103,  y26:51,  type:'Inf'},
  'Emily Boazman':        {y25:0,    y26:47,  type:'Inf'},
  'Eden Lee':             {y25:185,  y26:43,  type:'Inf'},
  'Katelyn Alsop':        {y25:0,    y26:40,  type:'Inf'},
  'Amy Erickson':         {y25:51,   y26:37,  type:'Inf'},
  'Lauren Stadler':       {y25:93,   y26:28,  type:'Inf'},
  'Jennie Hoglund':       {y25:29,   y26:25,  type:'Inf'},
  'Thuy Improta':         {y25:245,  y26:26,  type:'Inf'},
  'Ashley Turner':        {y25:39,   y26:21,  type:'Inf'},
  'Carly Brown':          {y25:0,    y26:19,  type:'Inf'},
  'Eryn Carroll NMM':     {y25:104,  y26:19,  type:'Inf'},
  'Taylor Moran':         {y25:62,   y26:19,  type:'Inf'},
  'Hayley Lombard':       {y25:0,    y26:16,  type:'Inf'},
  'Hilary Fritsch':       {y25:0,    y26:15,  type:'Inf'},
  'Devon Kuntzman':       {y25:90,   y26:15,  type:'Inf'},
  ...
  'Lexi Fitzgerald':      {y25:0,    y26:6,   type:'Inf'},
  'Taylor Dukes':         {y25:0,    y26:6,   type:'Inf'},
  ...
  'Courtland Nall':       {y25:10,   y26:9,   type:'Amb'},
  'Elise Hylden':         {y25:20,   y26:8,   type:'Amb'},
  'Hillary Ha':           {y25:0,    y26:11,  type:'Amb'},
  ...
  'Jessi Meeks':          {y25:0,    y26:5,   type:'Amb'},
  'Cy Tidwell':           {y25:12,   y26:4,   type:'Amb'},
  "Tania O'Donnell":      {y25:0,    y26:4,   type:'Amb'},
...
// Launch Bonus Tracker — updated from Salesforce export 2026-06-10
// 182 ambassadors with ≥1 bonus-eligible submission (YTD totals from tracker).
// Pre-2026 onboards: window starts 04/01/2026. 2026 onboards: window starts at onboard date.
// Tier computed from window subs (Apr 1+): Tier 2 = 50+, Tier 1 = 25-49.
const launchBonusData: {name:string;bonusSubs:number;tier:number;earned:number;winStart:string;winEnd:string;is2026?:boolean;omit?:boolean}[] = [
  {name:'Shannon Tripp',bonusSubs:270,tier:2,earned:1000,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Soshanna Salsman',bonusSubs:195,tier:2,earned:1000,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Lauren Johnson NNM',bonusSubs:164,tier:1,earned:500,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Kendra Needham',bonusSubs:150,tier:1,earned:500,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Jeff Cruz Talia_likeitis',bonusSubs:114,tier:1,earned:500,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Amy Bernhard',bonusSubs:110,tier:1,earned:500,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Melody Brandon',bonusSubs:87,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Ginny Yurich',bonusSubs:85,tier:1,earned:500,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Jasyra Santiago-Hines',bonusSubs:77,tier:1,earned:500,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Ellen Fisher',bonusSubs:62,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Taylor Kulik',bonusSubs:51,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Emily Boazman',bonusSubs:47,tier:1,earned:500,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Eden Lee loverlees',bonusSubs:43,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Katelyn Alsop (James)',bonusSubs:40,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Amy Erickson',bonusSubs:37,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Lauren Stadler',bonusSubs:28,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Thuy Improta *ministry*',bonusSubs:26,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Jennie Hoglund',bonusSubs:25,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Ashley Turner',bonusSubs:21,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Eryn Carroll NMM',bonusSubs:20,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Taylor Moran',bonusSubs:20,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Carly Brown',bonusSubs:19,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Hayley Lombard',bonusSubs:16,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Hilary Fritsch*',bonusSubs:15,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Melina Moses',bonusSubs:15,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Michelle Keijner',bonusSubs:15,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Taylor Weimar',bonusSubs:15,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Devon Kuntzman *Transforming Toddlerhood*',bonusSubs:14,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Erin Wilkins essentiallyerin',bonusSubs:13,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Hillary Ha',bonusSubs:11,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Karalynne Call *Just Ingredients*',bonusSubs:11,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Laura Manns',bonusSubs:10,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Brianna Reiser',bonusSubs:9,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Courtland Nall',bonusSubs:9,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Elise Hylden',bonusSubs:8,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Craig Clayton *Restoration Dentistry*',bonusSubs:7,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Dr. Ameet Trivedi truthdds',bonusSubs:7,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Karyna Cast Korotkykh',bonusSubs:7,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Rachel Jayroe',bonusSubs:7,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Sara Lininger',bonusSubs:7,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Carly Hartwig',bonusSubs:6,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Jordan Schoen',bonusSubs:6,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Julia Lee',bonusSubs:6,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Kelsey Sem (holisticmumma)',bonusSubs:6,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Lauren Peter',bonusSubs:6,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Lexi Fitzgerald',bonusSubs:6,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Mary Catherine Oechslin momnp',bonusSubs:6,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Taylor Dukes',bonusSubs:6,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Tiffany Hubbard',bonusSubs:6,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Ashley Vogt',bonusSubs:5,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Emily Morrow',bonusSubs:5,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Jessi Meeks',bonusSubs:5,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Wendy Ostapuk toxinfreeish',bonusSubs:5,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Amy Migdalia Williams',bonusSubs:4,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Anna Brayton riseandclimb',bonusSubs:4,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Bailey King',bonusSubs:4,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Brittany Lockie',bonusSubs:4,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Cy Tidwell',bonusSubs:4,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Janell Hampton',bonusSubs:4,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Kelsey Wall',bonusSubs:4,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Milli Twitchell mywholehomestead',bonusSubs:4,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Nikki Geib \"Making Millistones\"',bonusSubs:4,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Samantha Mauermann \'Acresandaprons\'',bonusSubs:4,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Tania O’Donnell',bonusSubs:4,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Tracy Gillet*',bonusSubs:4,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'adina natan',bonusSubs:3,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Alicia Farmer',bonusSubs:3,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Amber Thompson',bonusSubs:3,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Carly Patterson',bonusSubs:3,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Chad Rasmussen',bonusSubs:3,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Christina Franco',bonusSubs:3,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Erin Rice',bonusSubs:3,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Jennee Guerrero',bonusSubs:3,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Jessica Beachy',bonusSubs:3,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Kayla Monson',bonusSubs:3,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Kristin Hefley',bonusSubs:3,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Lexie Thiery',bonusSubs:3,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Logan Randazzo',bonusSubs:3,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Marissa Mason',bonusSubs:3,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Meghan Joy Yancy',bonusSubs:3,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Adrian Schroeder',bonusSubs:2,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Airwaymyos -Chantal Duhaime / Michelle Quinto',bonusSubs:2,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Amanda Cruz (closequartersmom)',bonusSubs:2,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Amy Rutt',bonusSubs:2,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Anne Barker',bonusSubs:2,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'April DelaFuente',bonusSubs:2,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Bethany Micek',bonusSubs:2,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Cara Gallardo',bonusSubs:2,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Christina Cooper-Gomm',bonusSubs:2,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Dawnita Stoltzfus',bonusSubs:2,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Doctor Mom Podcast',bonusSubs:2,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  ...
  {name:'Erin Stanczyk',bonusSubs:2,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Eryka Spera',bonusSubs:2,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Gina Primavera',bonusSubs:2,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Jackie Parliament',bonusSubs:2,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Janis Trout',bonusSubs:2,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Jessica Sansom',bonusSubs:2,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Kale Blossom',bonusSubs:2,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Kara Garcia',bonusSubs:2,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Karen Takacs',bonusSubs:2,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Katie Brooks',bonusSubs:2,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Kim Nelson',bonusSubs:2,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Krystina Ham',bonusSubs:2,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  ...
  {name:'Liz Haselmayer',bonusSubs:2,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Lori Beth Auldridge',bonusSubs:2,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Manon Salvi',bonusSubs:2,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Maurissa Ashby-Faulkner',bonusSubs:2,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Melissa Donahue',bonusSubs:2,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Michelle Melerine',bonusSubs:2,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Natalie Assell',bonusSubs:2,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Natalie Kennedy',bonusSubs:2,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Olesya Driga',bonusSubs:2,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Phylicia Borden',bonusSubs:2,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Ruby Morris',bonusSubs:2,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Sam Johnson',bonusSubs:2,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Sara Worth (Sara Joy oil_ohana)',bonusSubs:2,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Abby Tastad',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Alexis Martinez',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Allison Shaughnessy',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Amory Scott',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Amy Eck',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Amy Swanson',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'April Rodriguez',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Ashlee Wells*',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Ashley Acuna',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Ashney Patoka',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Bodybybree',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Brittany Greenfield',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Brooke Quinn*',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Brooke Winter',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Brook Merkel',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Cami Andersen',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Chelsea George Watkins',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Christa Jooste',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Dawn Winkelmann',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Desirea Peraza',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Dr Craig Clayton',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Elizabeth Tonneson',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Erika Sheffer Auckland',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Erin Blatchford',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Erin Doyle',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Eva Abrams',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Felicia Trager',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Hannah McNeely',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Heather Reed',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Heather Slack',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'India Lee',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Jessica Fay',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Jessica Klick',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Jessica Shuler',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Jessie Carlson',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Jordan Zavala',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Julie Smale',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Kara Barber',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Katie Dudley',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Katie Jewell',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Katie Nagel',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  ...
  {name:'Kristen Malabayabas',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Lindsey Price',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Mallory Reyes / Miller',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Marci Platt',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Marianne Moen',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Megan Wilson homestead',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Michele Chlopek-Grasmick',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Miranda Shell',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Natalie Stahl',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Nicole Stoltenberg STOLI',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Rose Stoltzfus',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Samantha Smith',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Sandy Caminata',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Sarah Fuller',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Tanya Marquez',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Tara Woodland',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Taylor Babich',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Taylor Calmus dudedad',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
  {name:'Vicki LaBarthe',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'12/31/2026'},
];
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
      ...
      <div>
        ...
        <div style={{ fontSize: '0.7rem', color: '#888', marginTop: 8, textAlign: 'center' }}>
          {launchBonusData.length} ambassadors with ≥1 submission. Source: Salesforce Launch Bonus Tracker, June 10 2026.
        </div>
      </div>
