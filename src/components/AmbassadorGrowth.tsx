...
const moversData: Record<string, {y25:number; y26:number; type:string}> = {
  'Shannon Tripp':        {y25:866,  y26:267, type:'Inf'},
  'Soshanna Salsman':     {y25:914,  y26:189, type:'Inf'},
  ...
  'Ginny Yurich':         {y25:291,  y26:83,  type:'Inf'},
  'Melody Brandon':       {y25:123,  y26:82,  type:'Inf'},
  'Jasyra Santiago-Hines':{y25:57,   y26:76,  type:'Inf'},
  'Ellen Fisher':         {y25:53,   y26:59,  type:'Inf'},
  'Taylor Kulik':         {y25:103,  y26:48,  type:'Inf'},
  'Emily Boazman':        {y25:0,    y26:43,  type:'Inf'},
  'Eden Lee':             {y25:185,  y26:42,  type:'Inf'},
  ...
  'Hilary Fritsch':       {y25:0,    y26:14,  type:'Inf'},
...
// Launch Bonus Tracker — updated from Salesforce export 2026-06-06
// 101 ambassadors with ≥1 bonus-eligible submission (counted from window start only).
...
const launchBonusData: {name:string;bonusSubs:number;tier:number;earned:number;winStart:string;winEnd:string;is2026?:boolean;omit?:boolean}[] = [
  {name:'Soshanna Salsman',bonusSubs:67,tier:2,earned:1250,winStart:'04/01/2026',winEnd:'04/01/2027',omit:true},
  ...
  {name:'Emily Boazman',bonusSubs:40,tier:1,earned:250,winStart:'04/02/2026',winEnd:'04/02/2027',is2026:true},
  ...
  {name:'Ginny Yurich',bonusSubs:25,tier:1,earned:250,winStart:'04/01/2026',winEnd:'04/01/2027'},
  ...
  {name:'Melody Brandon',bonusSubs:17,tier:0,earned:0,winStart:'04/01/2026',winEnd:'04/01/2027'},
  ...
  {name:'Hilary Fritsch',bonusSubs:13,tier:0,earned:0,winStart:'04/01/2026',winEnd:'04/01/2027'},
  ...
  {name:'Karyna Cast Korotkykh',bonusSubs:2,tier:0,earned:0,winStart:'04/01/2026',winEnd:'04/01/2027'},
  ...
  {name:'Anna Brayton',bonusSubs:1,tier:0,earned:0,winStart:'04/01/2026',winEnd:'04/01/2027'},
